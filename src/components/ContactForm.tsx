            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-gray-600 text-sm"><img src="https://flagcdn.com/16x12/us.png" alt="USA" className="inline align-middle mr-1" />+1 (913) 413-6583 <span className="text-xs text-green-600">(Solo WhatsApp)</span></div>
