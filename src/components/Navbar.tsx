      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <Link href="/" className="flex items-center gap-2">
            {/* El PNG exacto de la marca, el mismo lockup del avatar de Instagram y
                WhatsApp. Antes esto se dibujaba con CSS —una letra "X" en peso 700
                dentro de un cuadrito— y no coincidía con el de las redes. */}
            <img
