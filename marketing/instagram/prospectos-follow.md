# Prospectos para follow — crecimiento @xoultec

Lista curada de cuentas potenciales (clientes/usuarios) para seguir e iniciar relación.
Autorizado por Rubén (1-jul-2026): mezcla amplia de sectores; **armar lista + seguir yo pausado**
(~10-15/día máximo, espaciados) para no gatillar el filtro de spam en cuenta joven.

**Zonas objetivo:** RD 🇩🇴 · New Jersey · New York · Florida (diáspora dominicana).
**PRIORIDAD (Rubén, 1-jul-2026): RD primero.** Agotar/avanzar bien RD antes de invertir tiempo en cazar diáspora por hashtags.
**DISCRECIÓN (Rubén, 1-jul-2026):** la selección de rubros y prospectos queda a criterio del asistente
— variar sectores (retail, colmados, ferreterías, restaurantes, salones, distribuidoras, salud…),
verificar zona/calidad, y seguir pausado (~10-15/día máx). No hace falta pedir OK por cada tanda.
...
## Método (aprendizajes de la 1ª búsqueda, 1-jul)
- ✅ **RD**: el buscador de **cuentas** funciona muy bien — los negocios se nombran con handle tipo
  `farmacia_santo_domingo`, `boutique_santiago_rd`, `altagama_santiago_rd`. Buscar por rubro+ciudad.
- ⚠️ **Diáspora (NJ/NY/FL)**: el buscador de cuentas NO los encuentra (nadie pone "salon dominicano nj" de handle).
  Hay que cazarlos por **hashtags/ubicación** (#dominicanosennj, #njdominican, tags de lugar) → abrir posts → sacar la cuenta.
  Más lento; se hará gradual en el loop.

## ⚠️ Aprendizaje 2 (1-jul): "santo domingo" NO es fiable
Buscar "farmacia/tienda **santo domingo**" trae negocios de **México (Zacatecas)** y **Argentina (PAMI)** —
"Santo Domingo" es nombre común en toda LatAm. Para asegurar RD, usar el **sufijo `_rd`** o **`santiago rd`**
...
_Nota: "colmado" también se usa en Puerto Rico → verificar zona en bio antes de seguir._

_(Verificar cada una al momento de seguir: pública, activa, negocio real de RD. Saltar privadas/micro/fuera de zona.)_

## Seguidos (registro)
| Fecha | Handle | Nota |
|-------|--------|------|
| 2026-07-01 15:xx | altagama_santiago_rd | ALTA GAMA BOUTIQUE, Santiago. Pública, activa (14 posts). 1er follow proactivo. |
| 2026-07-01 16:xx | boutique_shein_santiago_rd | Tienda ropa online, envíos a todo RD (98 posts, 203 seg.). |
| 2026-07-01 16:xx | eykvirtualstore | Tienda relojes/retail Santiago RD, sólida (88 posts, 1,377 seg.). |
| 2026-07-01 16:xx | colmado_nona | COLMADO ÑOÑA, colmado RD popular (29.6K seg.). |
| 2026-07-01 16:xx | hamohouse_rd | HAMOHOUSE Ferretería y Decoración, RD (41.1K seg.). |
| 2026-07-01 16:xx | suplax_rd | SUPLAX Ferretería, Santo Domingo RD, grande (186K seg.). |
| 2026-07-01 17:xx | tinacos_rd | TINACOS_RD Ferretería/plomería, Sabana Perdida DN RD (47.2K seg.). |
| 2026-07-01 17:xx | ferreteriaexitord | Ferretería Éxito, materiales construcción, Santo Domingo RD (18.1K seg.). |
| 2026-07-01 17:xx | ainsatsrl | AINSAT, insumos médicos, Santo Domingo Este RD (ya nos seguía; +bienvenida). |
| 2026-07-02 09:30 | hernayil_santiago | Tienda Online Santiago RD, distrib./import selladores/materiales (724 seg.). |
| 2026-07-02 09:31 | nenesrd | Tienda virtual Santiago RD, ropa niños/jóvenes, pedidos por DM (162 seg.). |
...
| Handle | Motivo |
|--------|--------|
| farmaciasantodomingo9 | Fuera de zona: es de **Zacatecas, México** (bio: Av. Guerrero, tel 492). |
| farmacia.santo.domingo | Fuera de zona: menciona **PAMI** → probablemente **Argentina**. |
